...
\remarks{
    ...
    \begin{python}^^J
      COLLADAINCLUDE = ['/usr/local/include/collada-dom2.4', '/usr/local/include/collada-dom2.4/1.4']^^J
      COLLADALIBDIR  = ['/usr/local/Cellar/collada-dom/2.4.4/lib']^^J
      COLLADALIB     = ['collada-dom2.4-dp']^^J
    \end{python}
